...
class Autor(models.Model):
    ...
    data_nascimento = models.DateField("Data de Nascimento", default="1980-01-01", blank=True, null=True)
    email = models.EmailField("Email")
    idade = models.PositiveSmallIntegerField("Idade", blank=True, null=True)
